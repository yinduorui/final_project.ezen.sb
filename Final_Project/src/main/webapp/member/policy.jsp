...
<jsp:include page="../include/login_header.jsp"/>
	...
	<div class="agree_form">
		...
		<p class="guide_txt2" style="padding-top: 30px;">
			...
			<input type="checkbox" id="chkTotal" name='content' onclick='selectAll(this)' />
			<label for="chkTotal">전체선택</label>
		</p>
		<div class="etc_line"></div>
		<p class="guide_txt2">
			이용약관 동의
			<input type="checkbox" id="chkAppoint" name='content' />
			<label for="chkAppoint">선택</label>
		</p>
		<textarea rows="10" cols="60">
이용약관은 다음과 같은 내용을 담고 있습니다. (2019년 3월 7일 시행)
제1조(목적)
이 약관은 전기통신사업법령 및 정보통신망이용촉진, 전자상거래 등에 관한 법령에 의하여 (주)마지막이다(이하 "회사"라 합니다)가 제공하는 헬프키친의 서비스(이하 “서비스"라 한다) 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
제2조(약관의 효력 및 변경)
...
3. 본 약관 시행 전에 이미 가입된 회원은 변경 전의 약관이 적용됨을 원칙으로 합니다. 다만, 공지된 바에 따라 변경된 약관의 시행일 이후에도 본 약관에 따른 서비스를 계속 이용하는 경우에는 변경 후의 약관에 대해 동의한 것으로 봅니다.
		...
		<textarea rows="10" cols="60">
(주)마지막이다(이하 ‘회사’라 한다)는 개인정보 보호법 제30조에 따라 회사의 서비스를 이용하는 회원(이하 ‘이용자’라 한다) 의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립·공개합니다.
1. 총칙
...
나) 이전의 개인정보 처리방침은 아래에서 확인하실 수 있습니다.
		...
		<div class="etc_line">
			<p style="text-align: center;">
				<button class="agree" onclick="location.href='HelpkitchenServlet?command=member_join_form'">동의</button>
				<button class="agree" onclick="location.href='history.back()'">비동의</button>
			</p>
		</div>
	</div>
</body>
